...
)SELECT selected_user_follows.id, selected_user_follows.created_at, selected_user_follows.updated_at, selected_user_follows.user_id, selected_user_follows.feed_id, feeds.name AS feed_name, users.name AS user_name
